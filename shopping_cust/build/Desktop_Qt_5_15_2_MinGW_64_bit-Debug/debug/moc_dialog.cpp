...
QT_MOC_LITERAL(1, 14, 13), // "cancelWaiting"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 16) // "cancelBtnClicked"

    },
    "LoadingDialog\0cancelWaiting\0\0"
    "cancelBtnClicked"
};
...
void LoadingDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoadingDialog::cancelWaiting)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoadingDialog::cancelWaiting()
{
